...
export const DifferentiatorsSection = () => {
    const features = [
        ...
        { icon: Shield, title: "Grandes players", desc: "em breve... ", color: "from-red-400 to-red-600" },
        ...
        <section id="diferenciais" className="py-32 bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
            <div className="container mx-auto px-4 relative z-10">
                <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} className="text-center mb-20">
                    <Badge className="bg-[#01dfb2] text-white px-6 py-2 text-lg mb-6 rounded-full inline-block">Tecnologia Avançada</Badge>
                    ...
                    {features.map((item, index) => (
                        ...
                        >
                            <motion.div
                                ...
                                className="w-full"
                            >
                                <Card className="h-full p-12 bg-gray-800/50 border border-gray-700 rounded-2xl backdrop-blur-sm hover:bg-gray-700/50 transition-all duration-500">
