...
export const HeroSection = ({ scrollToSection }: { scrollToSection: (id: string) => void }) => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#01dfb2] via-[#00c9a7] to-[#00b399] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-20">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 1.2 }}>
          <p className="text-xl md:text-3xl text-white/90 mb-8 max-w-4xl mx-auto font-light">
            <TypingText text="Marketplace que conecta marcas, bares, clientes e motoboys em segundos." delay={50} />
          </p>
        </motion.div>
